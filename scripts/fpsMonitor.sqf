if (isDedicated) then {
    ...
    while {true} do {
        ...
        if (_myfps < 50) then {_myfpsmarker setMarkerColor "ColorYELLOW";};
        if (_myfps < 40) then {_myfpsmarker setMarkerColor "ColorORANGE";};
        if (_myfps < 30) then {_myfpsmarker setMarkerColor "ColorRED";};
