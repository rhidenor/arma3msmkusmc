...
//Distance from Release Point to open ramp and Red Light
_wpPos = _rp getPos [10000, _dir - 180];
_wpPos set [2, _alt];
_wp = _grp addWaypoint [_wpPos, -1, 0, "IP"];
private _waypointStatements = {
    _a = vehicle this;
    _a vehicleChat 'Jumplight Red! Stand Up WHEN the Jumpmaster tells you, and move to the ramp! 2 minutes left until the jump!';
	_a vehicleChat '2 minutes left to Release Point!';
