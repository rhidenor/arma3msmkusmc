...
onMapSingleClick {
    ...
    private _markerText = format ["Initial Point - %1", groupId group player];
    ...
    onMapSingleClick {
        ...
        private _markerText = format ["Release Point - %1", groupId group player];
        ...
        _okButton ctrlSetText (format ["Release Altitude %1 meter", _altFullForce]);
        ...
        _slider ctrlAddEventHandler ["SliderPosChanged", {
            ...
            private _okButton = (findDisplay 7777) displayCtrl 1;
            _okButton ctrlSetText format ["Release Altitude %1 meter", _newValue];
